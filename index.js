...
/*Task 1: counterMaker()
  ...
  Ans: counter1 is an object. counter2 is a fuction.

  2. Which of the two uses a closure? How can you tell?
  Ans: counter1 is a closure as it can access the counterMaker() variable.
...
function finalScore(inning, number/*code Here*/){
  ...
  let homeTeam = 0;
  let awayTeam = 0;
  //const currentTeamScore = inning(number);
  for(let i=0; i<number; i++){
    homeTeam = inning() + homeTeam; 
    awayTeam = inning() + awayTeam;
  }
